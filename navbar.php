...
<nav id="sidebar" class='mx-lt-5 bg-white'>
	...
	<div class="sidebar-list">
		...
		<?php if ($_SESSION['login_type'] == 1) : ?>
		<a href="index.php?page=payments_report" class="nav-item nav-payments_report"><span class='icon-field'><i class="fa fa-th-list"></i></span> Reportes de Pago</a><?php endif; ?>
		<?php if ($_SESSION['login_type'] == 1) : ?>
